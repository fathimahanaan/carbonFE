...
const getColorByEmission = (value) => {
  ...
  return "rgba(75, 192, 75, 0.8)"; // Low
};

export default function GetEmissionGraph() {
  const { weeklyEmissions, loading } = useGetWeeklyGraph();

  if (loading) return <p>Loading weekly emissions...</p>;
  ...
  return (
    <div
      style={{
        ...
        maxWidth: "750px",      // cap width on large screens
